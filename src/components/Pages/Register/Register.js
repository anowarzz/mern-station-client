...
const {createNewUser, updateUserProfile, user, setUser, logIn, googleLogIn, githubLogIn, facebookLogIn} = useContext(AuthContext)
...
const facebookLogInHandler = () => {
  ...
  return (
	...
	<div className="flex justify-center space-x-4">
		<button onClick={googleLogInHandler} aria-label="Log in with Google" className="p-3 rounded-sm hover:text-blue-700  flex flex-col justify-center items-center">
		...
		<button onClick={githubLogInHandler} aria-label="Log in with GitHub" className="p-3 rounded-sm  hover:text-blue-700  flex flex-col justify-center items-center">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
        ...
        <button onClick={facebookLogInHandler} aria-label="Log in with Facebook" className="p-3 rounded-sm  hover:text-blue-700  flex flex-col justify-center items-center">
    ...
    <p className="text-center sm:px-6 text-gray-600">Already Have An Account?
		<Link to="/login" className=" text-gray-800 m-2"> <button className='btn bg-black text-white px-2 py-1'>Login </button></Link>
	</p> 
      </div>
