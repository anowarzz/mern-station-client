...
const Login = () => {
    ...
    <label htmlFor="email" className='text-gray-700 mb-2'>Email</label>
                <div class="flex relative ">
                    ...
                    <input type="email" id="email" class=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-black placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent" placeholder="Email" required/>
                    </div>
                </div>
	...
	<div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 rounded-sm hover:text-blue-700  flex flex-col justify-center items-center">
		...
		<button aria-label="Log in with GitHub" className="p-3 rounded-sm  hover:text-blue-700  flex flex-col justify-center items-center">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
