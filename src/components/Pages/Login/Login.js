...
// User Login Info From Input Field
...
// Email Field Value Handling
const handleLoginEmail = (event) => {
const email = event.target.value;
setLoginInfo({...loginInfo, email: email})

    }
// Password Field Value Handling 
const handleLoginPassword = (event) => {
	...
	<p className="text-center sm:px-6 text-gray-600">Don't have an account?
		<Link to ="/register" className=" text-gray-800 m-2"> <button className='btn bg-black text-white px-2 py-1'>Register </button></Link>
	</p> 
</div>
       </div>
    );
